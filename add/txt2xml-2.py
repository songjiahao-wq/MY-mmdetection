...
voc_annotations = r'D:\lvting2\code\VOC_five\VOC_fiveyolo/annotations/test/'
yolo_txt = r'D:\lvting2\code\VOC_five\VOC_fiveyolo\labels\test/'
img_path = r'D:\lvting2\code\VOC_five\VOC_fiveyolo\images\test/'
labels = ['car', 'bus', 'bicycle', 'person', 'motorbike']  # label for datasets
# 图像存储位置
